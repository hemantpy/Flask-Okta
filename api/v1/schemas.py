...
filters = {
    ...
    ('v1_users_user_id', 'PATCH'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/UpdatedUserData'}}, 400: {'headers': None, 'schema': {'$ref': '#/definitions/Error'}}, 401: {'headers': None, 'schema': {'$ref': '#/definitions/Error'}}, 403: {'headers': None, 'schema': None}, 500: {'headers': None, 'schema': {'$ref': '#/definitions/Error'}}},
    ...
    ('v1_emails', 'POST'): {201: {'headers': None, 'schema': None}, 400: {'headers': None, 'schema': {'$ref': '#/definitions/Error'}}, 403: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
}

scopes = {
    ('v1_users', 'POST'): [],
    ('v1_users_user_id', 'PATCH'): [],
    ('v1_tokens', 'POST'): [],
    ('v1_tokens_token_id', 'DELETE'): [],
    ('v1_emails', 'POST'): [],
}
